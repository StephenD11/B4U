...
class NewOrderViewController: UIViewController {
    ...
    lazy var saveButton: UIButton = {
        ...
        btn.setImage(UIImage(named: "Button Save order light"), for: .normal)
        btn.setImage(UIImage(named: "Button Save order dark"), for: .highlighted)
    ...
    override func viewDidLoad() {
        ...
        saveButton.addTarget(self, action: #selector(buttonTouchUp), for: [.touchUpInside, .touchDragExit])
